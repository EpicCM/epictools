...
git fetch http://r.cyanogenmod.com/CyanogenMod/android_kernel_samsung_victory refs/changes/54/15654/4 && git cherry-pick FETCH_HEAD
echo "### Add sysfs control for capacitive backlights. http://review.cyanogenmod.com/#/c/15420"
git fetch http://r.cyanogenmod.com/CyanogenMod/android_kernel_samsung_victory refs/changes/20/15420/8 && git cherry-pick FETCH_HEAD
